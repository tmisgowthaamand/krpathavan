...
const TermsAndConditions = () => {
  return (
    ...
    >
      ...
      <h2 className="text-2xl mt-10 mb-4">1. General Use of Website & Services</h2>
      ...
      <h2 className="text-2xl mt-10 mb-4">2. Products & Pricing</h2>
      <ul className="list-disc pl-6 space-y-2 mb-8">
      ...
      <h2 className="text-2xl mt-10 mb-4">3. Orders & Payments</h2>
      <ul className="list-disc pl-6 space-y-2 mb-8">
      ...
      <h2 className="text-2xl mt-10 mb-4">4. Shipping & Delivery</h2>
      <ul className="list-disc pl-6 space-y-2 mb-8">
      ...
      <h2 className="text-2xl mt-10 mb-4">5. Cancellations & Returns</h2>
      <ul className="list-disc pl-6 space-y-2 mb-8">
      ...
      <h2 className="text-2xl mt-10 mb-4">6. Customer Responsibilities</h2>
      ...
      <h2 className="text-2xl mt-10 mb-4">7. Intellectual Property</h2>
      ...
      <h2 className="text-2xl mt-10 mb-4">8. Limitation of Liability</h2>
      <p className="mb-4">K R Pathavan Trading Company shall not be liable for:</p>
      <ul className="list-disc pl-6 space-y-2 mb-8">
      ...
      <p className="mb-8">Our liability is limited strictly to the value of the product purchased.</p>

      <h2 className="text-2xl mt-10 mb-4">9. Governing Law & Jurisdiction</h2>
      <p className="mb-8 leading-relaxed">
      ...
      <h2 className="text-2xl font-semibold mt-12 mb-4 text-charcoal">10. Contact Us</h2>
      <p className="mb-6 text-charcoal/80">For assistance or queries, please contact:</p>
